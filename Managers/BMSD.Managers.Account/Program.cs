        ...
        try
        {
                ...
                [FromServices] DaprClient daprClient, [FromServices] IMapper mapper) =>
            {
                ...
                try
                {
                    ...
                    var balanceInfo = await daprClient.InvokeMethodAsync<BalanceInfo>(HttpMethod.Get, "checkingaccountaccessor", $"GetBalance?accountId={accountId}");
                    if (balanceInfo == null)
                    {
                ...
                [FromServices] ILogger<AccountManager> logger, [FromServices] DaprClient daprClient, [FromServices] IMapper mapper) =>
            {
                ...
                try
                {
                    ...
                    var accountTransactionHistory = await daprClient.InvokeMethodAsync<AccountTransactionResponse[]>(
                ...
                [FromServices] ILogger<AccountManager> logger, [FromServices] DaprClient daprClient, [FromServices] IMapper mapper) =>
            {
                ...
                try
                {
                    ...
                    await daprClient.InvokeBindingAsync("accounttransactionqueue", "create", accountTransactionSubmit);
